...
if ! iamdaemon couchdb; then
	exit;
fi

if [ ! -d /etc/couchdb ]; then
	cat - <<EOF
CouchDB is not installed. See https://troyandgay.com/trac/projects/beerliberation/wiki/ITDocs#CouchDBserver
